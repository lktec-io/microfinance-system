...
const EXPECTED = {
  ...
  loans: {
    ...
    refund_incentive_rate:   'decimal',
    refund_incentive_amount: 'decimal',
  ...
  client_groups: {
    ...
    operational_duration_together: 'smallint',
    group_leader_id:               'int',
  },
  group_members: {
    id:                      'int',
    group_id:                'int',
    full_name:               'varchar',
    parent_or_guardian_name: 'varchar',
    phone_number:            'varchar',
    identity_type:           'enum',
    identity_number:         'varchar',
    residential_address:     'varchar',
    residential_area:        'varchar',
    residency_duration:      'smallint',
  ...
  member_businesses: {
    ...
    business_type:           'varchar',
    room_or_location_number: 'varchar',
    business_duration:       'smallint',
    average_weekly_sales:    'decimal',
    average_weekly_profit:   'decimal',
    ownership_type:          'enum',
    group_leader_name:       'varchar',
    group_leader_phone:      'varchar',
  },
  repayments: {
    paid_at:         'datetime',
...
const FOREIGN_KEYS = [
  ...
  ['client_groups', 'customer_id', 'customers'],
  ['client_groups', 'group_leader_id', 'group_members'],
  ['group_members', 'group_id', 'client_groups'],
  ['member_businesses', 'member_id', 'group_members'],
  ['loans', 'group_id', 'client_groups'],
];
